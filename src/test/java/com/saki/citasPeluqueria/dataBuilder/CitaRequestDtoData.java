...
public enum CitaRequestDtoData {
    ...
    SIN_FECHA(CitaRequestDto.builder()
            ...
            .clienteAnonimo(ClienteDto.builder().nombre("Junit1").build())
            .build()),
    ...
    CON_CLIENTE_ANONIMO(CitaRequestDto.builder()
            .fecha(LocalDate.of(2021,1,1))
            .hora(LocalTime.of(11,0))
            .clienteAnonimo(ClienteDto.builder().nombre("Cliente_JUnit1").tfno("221122336L").build())
            .build()),
    ...
    CON_ID_CLIENTE_Y_CLIENTE_ANONIMO(CitaRequestDto.builder()
            ...
            .hora(LocalTime.of(11,0))
            .idCliente(12354L)
            .clienteAnonimo(ClienteDto.builder().nombre("Cliente_JUnit2").tfno("221422336L").build())
            .build())
    ;
